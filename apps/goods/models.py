...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="商品类目", on_delete=models.CASCADE, null=True)
...
class Goods(models.Model):
    ...
    商品
    """
    category = models.ForeignKey(GoodsCategory, null=True, verbose_name="商品类目", on_delete=models.CASCADE)
    ...
    goods_desc = UEditorField(verbose_name="内容", imagePath="goods/images/", width=1000, help_text="内容",
